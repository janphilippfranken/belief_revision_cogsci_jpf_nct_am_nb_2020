...
// transforming 1-99 confidence position scale into 1-850 confidence value scale
...
// log slider for variance computation based on confidence value. The fact that the value scale is larger than the 
// position scale (i.e. 0-850 vs 1-99) prevents that participants can respond with too high confidence values.
...
// transforming the confidence slider value back into the confidence slider position (currently redundant equivalent participants can use the whole range of responses)
